...
const char* post =
 ...
 "vec3 t(vec3 g)"
 "{"
   "float v=.15,z=.5,n=.1,i=.2,e=.01,d=.3,y=90,t=4;"
   "g*=t;"
 ...
 "{"
   ...
   "for(int f=0;f<i;++f)"
     "d.x+=t*texture(v,.5-.5*(g*e)).x,d.y+=t*texture(v,.5-.5*(g*y)).y,d.z+=t*texture(v,.5-.5*(g*n)).z,e*=.99972,y*=.9998,n*=.99988;"
   "return d;"
 "}"
 "vec3 e(vec2 z)"
 "{"
 ...
 "{"
   ...
   "v+=-1*e(gl_FragCoord.xy+vec2(0,1));"
   "v=mix(g,v,.1);"
   "gl_FragColor.xyz=pow(v,vec3(1/z));"
 "}";
